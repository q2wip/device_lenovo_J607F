...
# Ramdisk contents (init_first_stage, snapuserd, toolbox)
$(call inherit-product, $(SRC_TARGET_DIR)/product/generic_ramdisk.mk)

# Keep PAGE_SIZE macro for vendor code (override A16 default)
PRODUCT_NO_BIONIC_PAGE_SIZE_MACRO := false

# Disable kernel FCM version check in VINTF (kernel 4.19 too old for FCM v6)
...
# Telephony (Wi-Fi tablet — included for IMS compatibility)
PRODUCT_COPY_FILES += \
...
# USB — use A13 prebuilt (HIDL), source-built AIDL crashes
# Component overrides
...
PRODUCT_PACKAGES += \
    ...
    recovery.ld.config.txt \
    system.dir_placeholder \
    init.target.rc \
    ueventd.qcom.rc
